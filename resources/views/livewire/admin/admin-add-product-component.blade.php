        ...
        <form method="POST" action="{{ route('admin.addnewproduct') }}" enctype="multipart/form-data"
            ...
            <div class="col-12">
                ...
                <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="images" style="color:rgb(8, 8, 8)"><i
                            class="fad fa-images"></i> Choisissez l'image</label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="select-option col-12">
                    ...
                    <div class="form-check ml-5">
                        <input type="radio" name="trans" class="form-check-input" id="trans_no" value="non"
                            onclick="desactiver()" checked>
                        <label class="form-check-label" for="sans_trans">
                            Sans transport
                        </label>
                    </div>
                    <div class="form-check ml-5">
                        <input type="radio" name="trans" class="form-check-input" id="trans_ok" value="oui"
                            onclick="show()">
                ...
                <div class="col-lg-6">
                    <div class="form-group" id="trans_eco" style="display: none">
                        ...
                        <input type="text" class="form-control" name="bus" value="0" id="business">
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                {{-- <div class="col-12">
                    <table class="table table-bordered" id="dynamicName">
                        ...
                        <tr>
                            <td><input type="text" name="nom_ville[]" placeholder="Enter nom ville"
                                    class="form-control" />
                            </td>
                            <td><button type="button" name="add" id="dynamic" class="btn btn-warning">ajouter</button>
                            </td>
                        </tr>
                    </table>
                </div> --}}
                ...
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success " style="margin-top:20px;width:300px"><i
                            class="fas fa-plus-circle"></i> Suivant </button>
