                    ...
                    <div class="row pt-5">
                        <div class="col-lg-4 text-center">
                            ...
                            <h3 class="text-light"> <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path class="st0"
                                        d="M13.1,34.8l14.5-7.1l7.1-14.5l-14.5,7.2L13.1,34.8z M24,26c-0.6,0-1-0.2-1.4-0.6C22.2,25,22,24.6,22,24
                        ...
                        <div class="col-lg-4  text-center">
                            <h3 class="text-light"> <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path class="st0"
                                        d="M17.3,45l-3.8-6.5L5.9,37l0.9-7.4L2,24l4.8-5.5l-0.9-7.4l7.6-1.6L17.3,3L24,6.1L30.7,3l3.8,6.6l7.5,1.6
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Tous droits réservés </p></div>
        ...
        <script type="text/javascript">
            ...
            $("#dynamic-ar").click(function() {
                ++i;
                $("#dynamicAddRemove").append('<tr><td><input type="text" name="nom_ville[' +
                    i +
                    ']" placeholder="Enter nom ville" class="form-control" /></td><td><input type="text" name="all_date[' +
                    i +
                    ']" placeholder="Enter nom ville" class="form-control" /></td><td><input type="text" name="duree[' +
                    i +
                    ']" placeholder="Enter la durée " class="form-control" /></td><td><input type="text" name="prix_date[' +
                    i +
                    ']" placeholder="Enter prix" class="form-control" /></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>'
                );
            });
            $(document).on('click', '.remove-input-field', function() {
                $(this).parents('tr').remove();
