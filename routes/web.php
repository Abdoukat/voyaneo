...
use App\Http\Livewire\Admin\AdminOffre;
...
Route::get('/offre/{id}', [DetailsComponent::class, 'offreDate'])->name('product.offreDate');
...
Route::middleware(['auth:sanctum', 'verified', 'authadmin'])->group(function () {
    ...
    Route::get('/admin/offre', AdminOffre::class)->name('admin.offre');
    Route::post('/admin/offre/add', [AdminOffre::class, 'offre_plus'])->name('admin.addoffre');
    Route::get('/admin/city', AdminCityComponent::class)->name('admin.city');
    Route::post('/admin/city/add', [AdminCityComponent::class, 'addCity'])->name('admin.addcity');
    Route::get('/admin/city/delete/{id}', [AdminCityComponent::class, 'destroy'])->name('admin.deletecity');
});
